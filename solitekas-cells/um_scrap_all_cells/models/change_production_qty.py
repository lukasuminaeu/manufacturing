...
class ChangeProductionQty(models.TransientModel):
    ...
    def change_prod_qty(self):
        """Inserting this function there, to override function in enterprise/mrp_workorder/wizard/ 'def change_prod_qty'
        to not throw Warning when trying to update the desired production quantity for MO
        """
